...
export const ETH_LATAM_ATTENDEES_GROUP_URL = `${ETH_LATAM_PIPELINE_URL}/${ETH_LATAM_ATTENDEES_GROUP_ID}`;
export const ETH_LATAM_ORGANIZERS_GROUP_ID = `${process.env.NEXT_PUBLIC_ETH_LATAM_ORGANIZERS_GROUP_ID}`;
export const ETH_LATAM_ORGANIZERS_GROUP_URL = `${ETH_LATAM_PIPELINE_URL}/${ETH_LATAM_ORGANIZERS_GROUP_ID}`;
